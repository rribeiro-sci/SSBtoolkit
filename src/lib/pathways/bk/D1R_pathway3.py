...
def network(pKd,ligand,epsilon):
    ...
    Monomer('RK', ['b'])
    Monomer('Arr', ['Arr_b1', 'Arr_p1', 'Arr_p2'])
    Monomer('Ops')
    ...
    Initial(Arr(Arr_b1=None, Arr_p1=None, Arr_p2=None), Parameter('Arr_0', 3000))
    ...
    Rule('RecT', Rec(b=None, b1=None, s='T') + Ca(Ca_b1=None, Ca_l='cytos', Ca_s='free') | Rec(b=1, b1=None, s='R') % Ca(Ca_b1=1, Ca_l='cytos', Ca_s='buff'), kRec1, kRec2)

    # Binding of RK to Rec
    bind_complex(Rec(b=1, b1=None, s='R') % Ca(Ca_b1=1, Ca_l='cytos', Ca_s='buff'), 'b1', RK(b=None), 'b', [kRec3, kRec4])

    ##### RK PATHWAY #####
    # Binding of Rho and Rk.
    bind(RK(b=None), 'b', D1R(D1R_b1=None, D1R_p='p0', D1R_s='a'), 'D1R_b1', [kRK1, kRK2])

    #Phosphorilation of Rho by RK
    Rule('Rho_phosphorilation', RK(b=50)%D1R(D1R_b1=50, D1R_p='p0', D1R_s='a') >> RK(b=50)%D1R(D1R_b1=50, D1R_p='p1', D1R_s='a'), kRK3)

    #Dissociation of the complex RK.Rho
    Rule('Rho_RK_dissociation', RK(b=50)%D1R(D1R_b1=50, D1R_p='p1', D1R_s='a') >> RK(b=None) + D1R(D1R_b1=None, D1R_p='p1', D1R_s='a'), kRK4)
    ...
    bind(D1R(D1R_b1=None, D1R_p='p1', D1R_s='a'), 'D1R_b1', Arr(Arr_b1=None, Arr_p1=None, Arr_p2=None), 'Arr_b1', [kA1, kA2])

    # Arr -mediated inactivation of Rho. Ops indicates the ligand-free receptor
    #Rule('Rho_Ops', D1R(D1R_b1=50, D1R_p='p1', D1R_s='a')%Arr(Arr_b1=50, Arr_p1=None, Arr_p2=None) >> Ops() + Arr(Arr_b1=None, Arr_p1=None, Arr_p2=None), kA3)

    # Thermal decay of catalyti
    Rule('Rho_decay', D1R(D1R_b1=None, D1R_p='p0', D1R_s='a') >> Ops(), ktherm)

    #Recycle of Ops to R (not activated by photons)
    Rule('Rho_recycle', Ops() >> D1R(D1R_b1=None, D1R_p='p0', D1R_s='i'), kRecyc) # we need to add the receptor activation reaction, otherwise the concentration of R will be artificial increased.

    ## ARR homo-tetramerization
    assemble_pore_sequential(Arr(Arr_b1=None, Arr_p1=None, Arr_p2=None),'Arr_p1','Arr_p2', 4,[[kA4,kA5],[kA4,kA5],[kA4,kA5]])
    Rule('Dimer', Arr(Arr_b1=None, Arr_p1=None, Arr_p2=None) + Arr(Arr_b1=None, Arr_p1=None, Arr_p2=None) | Arr(Arr_b1=None, Arr_p1=None, Arr_p2=1) % Arr(Arr_b1=None, Arr_p1=1, Arr_p2=None), kA1, kA2)
    Rule('tetramerization', Arr(Arr_b1=None, Arr_p1=None, Arr_p2=1) % Arr(Arr_b1=None, Arr_p1=1, Arr_p2=None) + Arr(Arr_b1=None, Arr_p1=None, Arr_p2=1) % Arr(Arr_b1=None, Arr_p1=1, Arr_p2=None) | Arr(Arr_b1=None, Arr_p1=1, Arr_p2=2) % Arr(Arr_b1=None, Arr_p1=2, Arr_p2=3) % Arr(Arr_b1=None, Arr_p1=1, Arr_p2=4) %  Arr(Arr_b1=None, Arr_p1=4, Arr_p2=3), kA1, kA2)
