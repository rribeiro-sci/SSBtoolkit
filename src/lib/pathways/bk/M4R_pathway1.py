...
def network(pKd,ligand):
    ...
    Monomer('Ach', ['Ach_b1'])
    Monomer('M4R', ['M4R_b1', 'M4R_p', 'M4R_s'], {'M4R_p':['p0','p1'], 'M4R_s':['i','a']})
    Monomer('Gi', ['Gi_b1'])
    Monomer('Gbgolf')
    ...
    #INITIAL CONDITIONS
    Initial(D1R(D1R_b1=None, D1R_p='p0', D1R_s='a'), Parameter('D1R_DA_0', 0))   # nM
    Initial(D1R(D1R_b1=None, D1R_p='p0', D1R_s='i'), Parameter('D1R_0', 2000))   # nM
    Initial(Golf(Golf_b1=None), Parameter('Golf_0', 2000.0))             # nM
    Initial(Ach(Ach_b1=None), Parameter('Ach_0', 100.0))                 # nM
    Initial(M4R(M4R_b1=None, M4R_p='p0', M4R_s='a'), Parameter('M4R_ACH_0', LR))   # nM
    Initial(M4R(M4R_b1=None, M4R_p='p0', M4R_s='i'), Parameter('M4R_0', 2000.0-LR))   # nM
    ...
    Rule('reaction6', M4R(M4R_b1=None, M4R_p='p0', M4R_s='a') + Gi(Gi_b1=None) | M4R(M4R_b1=50, M4R_p='p0', M4R_s='a') % Gi(Gi_b1=50), kM4R_Gi_1, kM4R_Gi_2)
    ...
    Rule('reaction12', M4R(M4R_b1=50, M4R_p='p0', M4R_s='a') % Gi(Gi_b1=50) >> M4R(M4R_b1=None, M4R_p='p0', M4R_s='a') + GaiGTP(GaiGTP_b1=None) + Gbgi() , kM4R_DA_Gi_decay)
    ...
    Observable('obs_RL',D1R(D1R_b1=None, D1R_p='p0', D1R_s='a'))
    Observable('obs_Golf',Golf(Golf_b1=None))
    #Observable('obs_Ach',Ach(Ach_b1=None))
    Observable('obs_M4R',M4R(M4R_b1=None, M4R_p='p0', M4R_s='i'))
    Observable('obs_M4R_Ach',M4R(M4R_b1=None, M4R_p='p0', M4R_s='a'))
    ...
    Observable('obs_M4R_Gi',M4R(M4R_b1=50, M4R_p='p0', M4R_s='a') % Gi(Gi_b1=50))
...
list_of_observables=['obs_D1R','obs_RL','obs_cAMP']
