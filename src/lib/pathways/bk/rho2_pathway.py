################################################################################
##                      THE RHODOSPIN CASCADE VERSION 2.0                     ##
##                        last modification 28 Feb 2018                       ##
##      SOURCES:                                                              ##
...
#Vizualise
layout = dict(title ='',
              xaxis = dict(title = 'Time (s)', type='log'),
              yaxis = dict(title = 'conc'),
              autosize=False,
              width=750,
              height=450)

go.FigureWidget(data=[t, yout['obs_GMP']], layout=layout)
#pl.figure()
#pl.subplot(211)
#pl.plot(t, yout['obs_GMP'], label="GMP")
#pl.subplot(212)
#pl.plot(t, yout['obs_cGMP'], label="cGMP")
